...
*/
final class Version20240516160201 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('ALTER TABLE rapport_veterinaire ADD utilisateur_id INT NOT NULL, ADD animal_id INT DEFAULT NULL');
